...
export default class app extends Component{
    ...
    enterIconLoading=(cb)=>{
        let _this = this;
            ...
            this.props.ontranstion(this.state.transtion,()=>{
                _this.setState({
                    iconLoading:false,
                })
            })
        ...
        if(this.props.xz){
            ...
            return(
                <div className={"search"}>
                    <Cascader style={{width:"300px"}} options={options} onChange={this.onChange} allowClear={true} placeholder={"省 、 市 、 区 、"}/>
